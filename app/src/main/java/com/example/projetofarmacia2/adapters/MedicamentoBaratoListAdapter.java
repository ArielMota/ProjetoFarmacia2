...
public class MedicamentoBaratoListAdapter extends RecyclerView.Adapter<MedicamentoBaratoListAdapter.ListViewHolder> implements Filterable {
    ...
    public MedicamentoBaratoListAdapter(List<Medicamento> medicamentos, Context context, Activity activity) {
    ...
    public ListViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = inflater.inflate(R.layout.item_list_medicamento,viewGroup,false);
...
;
        ...
        TextView nome_farmacia =  listViewHolder.nomeFarmacia;
        nome_farmacia.setText(String.valueOf(medicamento.getFarmacia().getNome()));

        TextView preco_medicamento =  listViewHolder.precoMedicamento;
        preco_medicamento.setText(String.valueOf(medicamento.getPreco()));
    ...
    public class ListViewHolder extends  RecyclerView.ViewHolder {
        ...
        public ListViewHolder(@NonNull View itemView) {
            ...
            nomeFarmacia = (TextView) itemView.findViewById(R.id.nome_farmacia);
